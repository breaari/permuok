...
class DevelopmentAICopyService
{
    ...
    private static function generateCopy(
        ...
        /*
     * Contexto de negocio.
     * El userId representa al usuario que
     * efectivamente pidió generar el contenido.
     */
        $pdo = self::db();
    ...
    ");
        ...
        try {
            ...
            AiUsageService::log([
                ...
                'operation' =>
                $copyType === 'title'
                    ? 'development_copy_title'
                    : 'development_copy_description',
