...
export default function Gate() {
  ...
  if (level === "real_estate_not_linked") return <Navigate to="/onboarding" replace />;
if (level === "real_estate_draft") return <Navigate to="/onboarding" replace />;
if (level === "real_estate_review") return <Navigate to="/status/review" replace />;
