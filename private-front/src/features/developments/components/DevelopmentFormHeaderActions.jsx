...
function ActionTile({
  ...
  const variants = {
    ...
    danger: "bg-rose-50 border-rose-200 text-rose-700 hover:bg-rose-100/80",
  };
...
export default function DevelopmentFormHeaderActions({
  status = "",
  isEditMode = false,
  isSubmitting = false,
  onSaveDraft,
          ...
          <>
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
                  ...
                  <p className="text-sm text-slate-500 font-medium">
                    Podés gestionar el estado del desarrollo desde acá.
                  </p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 gap-3 md:grid-cols-5">
              ...
              <ActionTile
                ...
                variant="primary"
              >
                {effectiveStatus === "paused" || effectiveStatus === "archived"
                  ? "Republicar"
                  : "Publicar"}
              </ActionTile>
