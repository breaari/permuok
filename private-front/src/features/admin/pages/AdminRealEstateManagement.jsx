    ...
    useCallback(
      async (query = "") => {
        try {
          ...
          const res =
            await api.get(
              `/admin/real-estates/operational/counts${
                qs
                  ? `?${qs}`
                  : ""
              }`,
      ...
      async ({
        ...
        try {
          ...
          setErr(
            getErrorMessage(
              e,
              "No se pudieron cargar las inmobiliarias.",
            ),
          );
        } finally {
          if (
    ...
    <div className="space-y-8">
      <div className="space-y-2">
        ...
        <p className="max-w-3xl text-base text-slate-500">
          Gestioná las inmobiliarias habilitadas en la plataforma, su estado operativo, membresía y actividad.
        </p>
      </div>
